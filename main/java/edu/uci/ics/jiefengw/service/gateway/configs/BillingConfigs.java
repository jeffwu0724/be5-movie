package edu.uci.ics.jiefengw.service.gateway.configs;
...
public class BillingConfigs {
    ...
    private String discountCreatePath;
    private String discountApplyPath;
...
//            private String DiscountApplyPath;
            ...
            discountCreatePath = cm.getBillingEndpoints().get("discountCreate");
            if (discountCreatePath == null) {
                System.err.println("Discount Create Retrieve Path not found in configuration file.");
            } else {
                System.err.println("Discount Create Retrieve Path: " + discountCreatePath);
            }

            discountApplyPath = cm.getBillingEndpoints().get("discountApply");
            if (discountApplyPath == null) {
                System.err.println("Discount Apply Complete Path not found in configuration file.");
            } else {
                System.err.println("Discount Apply Complete Path: " + discountApplyPath);
            }
        }
    }
    ...
    public String getDiscountCreatePath() {
        return discountCreatePath;
    }

    public String getDiscountApplyPath() {
        return discountApplyPath;
    }
}